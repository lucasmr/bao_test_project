...
// Test contract of a "game", user levels up with more tokens
contract NewGame is Ownable, Authorizable {
    using SafeMath for uint256;
    ...
    //GameToken public GTK;
    IERC20 Token;
    
    // hash table of every user that deposited.
    mapping (address => UserInfo) public userGlobalInfo;
